...
public class SQL extends DatabaseConnector implements IDatabase
{
    ...
    public boolean insertLocation(String name, String geo_long, String geo_lat)
    {
        ...
        try
        {
            String query = "INSERT INTO location (name, geo_long, geo_lat)" 
                    + " values (?,?,?)";
            PreparedStatement prest = conn.prepareStatement(query);
    ...
    public ArrayList<String> retrieveLocations()
    {
        ...
        try
        {
            ...
            {                
                ...
                String geo_long = res.getString("idfile");
                String geo_lat = res.getString("type");
                
                String result = "-LOCATION_NAME:" + name + "-LOCATION_LONG:" + geo_long + "-LOCATION_LAT:" + geo_lat;
